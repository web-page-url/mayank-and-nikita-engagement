...
export default function Chatbot({ isDark = false }: ChatbotProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'Hello! 💕 I\'m LoveBot, your AI assistant for Mayank & Nikita\'s engagement celebration. How can I help you with the wedding details?',
      sender: 'bot',
      timestamp: new Date()
    }
  ]);
  ...
  const callGeminiAPI = async (prompt: string): Promise<string> => {
    ...
    try {
      ...
      const systemPrompt = `You are LoveBot, an AI assistant for Mayank & Nikita's engagement celebration website.
...
User query: ${prompt}`;
      ...
      return 'Sorry, I\'m having trouble connecting right now. Please try again later or contact Mayank and Nikita directly!';
    }
  };
