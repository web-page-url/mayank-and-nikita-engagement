...
const images = [
  { src: couple1, alt: "Mayank & Nikita golden hour moment" },
  { src: couple2, alt: "Mayank & Nikita laughing together" },
  { src: couple3, alt: "Mayank & Nikita dancing under fairy lights" },
  { src: couple4, alt: "Mayank & Nikita intimate portrait" },
];
